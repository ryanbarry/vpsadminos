{
  ...
  osctl-repo = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "15cmpgdgn8cf4cbdy08n9j7cx3d9ilxgsa5k5r51lm8ci09l1z50";
      type = "gem";
    };
    version = "24.05.0.build20241101175555";
  };
  osctld = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1xam2mrj3f8c32kyqw7zljv5gybdpvr1z3mf1srs539b3r47j3yd";
      type = "gem";
    };
    version = "24.05.0.build20241101175555";
  };
  osup = {
    ...
    source = {
      remotes = ["https://rubygems.vpsfree.cz"];
      sha256 = "1cwpjyxdxvsr3r6jbi191zg7qkf7v8fzlmgh8g97qw9z7g6gqgcg";
      type = "gem";
    };
    version = "24.05.0.build20241101175555";
  };

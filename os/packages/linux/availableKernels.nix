...
let
  ...
  kernels = {
    "6.11.4" = {
      url = linuxGhUrl vpsfGh "74eb8f8a5b564151747e670911c0141d9d0e90cb";
      sha256 = "sha256-pHhbCng23FLAVxdJn3GziUm5BIWuFHLQPS9lGZf9cdc=";
      zfs = {
        rev = "638a59067b1fb51e1c9f3ea26dc570e6f574d3bc";
        sha256 = "sha256-srBK5Y1BAdJqLi35gfefxgZoyvCoeSlN91U6Z2KlYuY=";
      };
    };
    "6.10.12" = {
      ...
      zfs = {
        rev = "a719e13c7916337801487e74245f2a91f8c8e72a";
        sha256 = "sha256-UO4QHk9zoj33R488fEEtc+8JQgJUUwucGacJA4miq2U=";
      };
    };
    "6.10.11" = {
